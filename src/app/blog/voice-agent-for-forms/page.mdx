                ...
                messages=[
                    MessagesGroq(
                        ...
                        content=(
                            ...
                            f"If the questions are not in the same language of {data.language}, you must translate theme."
                            f"Example:"
        ...
        async def voice_agents(websocket: WebSocket):
            try:
                ...
                while True:
                    ...
                    next_question = None if session.current_index + 1 >= len(session.questions) else session.questions[session.current_index + 1]
