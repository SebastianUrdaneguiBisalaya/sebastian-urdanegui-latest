export default function Navbar() {
    return (
        <nav className="w-full py-4 flex flex-col gap-2">
            <h1 className="text-lg text-white font-sora text-center font-medium">Sebastian Marat Urdanegui Bisalaya</h1>
            <h2 className="font-reddit-sans text-center text-gray-400 font-medium">Full-Stack Developer & Data Analyst</h2>
            <div
            ...
            >
                ...
                <svg
                    ...
                    ><g clipPath="url(#IconifyId198beeb14fada8c171)"
                        ...
                        fill="currentColor"
                        ></path></g><defs
                        ><clipPath id="IconifyId198beeb14fada8c171"><path d="M0 0h14v14H0z" fill="currentColor"></path></clipPath></defs></g>
                    </svg>
                </a>
                <a
                    className="opacity-50 flex flex-col items-center justify-center h-6 w-auto cursor-pointer hover:opacity-100 text-gray-300 transition-all duration-500 ease-out"
